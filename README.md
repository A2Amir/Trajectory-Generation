...
3.	[cost_functions.py](https://github.com/A2Amir/Trajectory-Generation/blob/master/Python/cost_functions.py) - This file contains many cost functions which are used in ptg.py when selecting the best trajectory. Some cost functions aren't yet implemented.

4.	[evaluate_ptg.py](https://github.com/A2Amir/Trajectory-Generation/blob/master/Python/evaluate_ptg.py) - This file sets a start state, goal, and traffic conditions and runs the PTG code. Feel free to modify the goal, add traffic, etc... to test your vehicle's trajectory generation ability.

5.	[constants.py](https://github.com/A2Amir/Trajectory-Generation/blob/master/Python/constants.py) - constants like speed limit, vehicle size, etc... 

6.	[helpers.py](https://github.com/A2Amir/Trajectory-Generation/blob/master/Python/helpers.py) - helper functions used by other files.
